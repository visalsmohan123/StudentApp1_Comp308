...
function Vt() {
  ...
  function ne(n, s, h) {
    this.props = n, this.context = s, this.refs = Fe, this.updater = h || H;
  }
  ...
  function pe(n, s, h) {
    ...
    if (n && n.defaultProps)
      for (C in T = n.defaultProps, T)
        _[C] === void 0 && (_[C] = T[C]);
    return { $$typeof: J, type: n, key: P, ref: k, props: _, _owner: q.current };
  }
  function Ce(n, s) {
  ...
  function G(n, s, h, C, _) {
    ...
    if (k)
      return k = n, _ = _(k), n = C === "" ? "." + z(k, 0) : C, oe(_) ? (h = "", n != null && (h = n.replace(Se, "$&/") + "/"), G(_, s, h, "", function(W) {
        return W;
    ...
    if (k = 0, C = C === "" ? "." : C + ":", oe(n))
      ...
      for (n = w.call(n), T = 0; !(P = n.next()).done; )
        P = P.value, w = C + z(P, T++), k += G(P, s, h, w, _);
    else if (P === "object")
  ...
  return g.Children = { map: U, forEach: function(n, s, h) {
    ...
    return n;
  } }, g.Component = ne, g.Fragment = Re, g.Profiler = de, g.PureComponent = I, g.StrictMode = X, g.Suspense = $, g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Te, g.cloneElement = function(n, s, h) {
    if (n == null)
...
var ft;
function Ut() {
  return ft || (ft = 1, function(J, y) {
    process.env.NODE_ENV !== "production" && function() {
      typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
      var Re = "18.2.0", X = Symbol.for("react.element"), de = Symbol.for("react.portal"), re = Symbol.for("react.fragment"), te = Symbol.for("react.strict_mode"), Q = Symbol.for("react.profiler"), $ = Symbol.for("react.provider"), Z = Symbol.for("react.context"), L = Symbol.for("react.forward_ref"), V = Symbol.for("react.suspense"), ee = Symbol.for("react.suspense_list"), H = Symbol.for("react.memo"), se = Symbol.for("react.lazy"), Fe = Symbol.for("react.offscreen"), ne = Symbol.iterator, ae = "@@iterator";
      function I(e) {
      ...
      function br(e, r, a) {
        ...
        if (r != null) {
          Be(r) && (l = r.ref, tr(r)), ge(r) && (Pe(r.key), p = "" + r.key), v = r.__self === void 0 ? null : r.__self, E = r.__source === void 0 ? null : r.__source;
          for (o in r)
        ...
        return xe(e, p, l, v, E, q.current, i);
      }
      function Er(e, r) {
      ...
      function Rr(e, r, a) {
        ...
        if (r != null) {
          Be(r) && (l = r.ref, O = q.current), ge(r) && (Pe(r.key), p = "" + r.key);
          var j;
          e.type && e.type.defaultProps && (j = e.type.defaultProps);
          for (o in r)
            je.call(r, o) && !Ne.hasOwnProperty(o) && (r[o] === void 0 && j !== void 0 ? i[o] = j[o] : i[o] = r[o]);
        }
      ...
      function be(e, r, a, o, i) {
        ...
        if (l) {
          var v = e, E = i(v), O = o === "" ? nr + Ae(v, 0) : o;
          if ($e(E)) {
            var j = "";
            O != null && (j = ve(O) + "/"), be(E, r, j, "", function(Wt) {
              return Wt;
            });
          } else
        ...
        var x, D, M = 0, B = o === "" ? nr : o + Cr;
        if ($e(e))
          for (var yr = 0; yr < e.length; yr++)
            x = e[yr], D = B + Ae(x, yr), M += be(x, r, a, D, i);
        else {
          var Nr = I(e);
          if (typeof Nr == "function") {
            var ut = e;
            Nr === ut.entries && (We || ue("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), We = !0);
            for (var Nt = Nr.call(ut), it, Mt = 0; !(it = Nt.next()).done; )
              x = it.value, D = B + Ae(x, Mt++), M += be(x, r, a, D, i);
          } else if (p === "object") {
            var st = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === re || e === Q || G || e === te || e === V || e === ee || z || e === Fe || we || Ye || Se || typeof e == "object" && e !== null && (e.$$typeof === se || e.$$typeof === H || e.$$typeof === $ || e.$$typeof === Z || e.$$typeof === L || // This needs to include all possible module reference object
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`), e;
      ...
      function _t() {
        {
          if (He === 0) {
            Wr = console.log, Vr = console.info, Ur = console.warn, Yr = console.error, Br = console.group, qr = console.groupCollapsed, zr = console.groupEnd;
            var e = {
              configurable: !0,
              enumerable: !0,
              value: Hr,
      ...
      var xr = U.ReactCurrentDispatcher, Ar;
      function cr(e, r, a) {
        {
          if (Ar === void 0)
            try {
      ...
      function wt(e, r, a, o, i) {
        {
          ...
          for (var l in e)
            if (p(e, l)) {
              ...
              v && !(v instanceof Error) && (dr(i), d("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", a, l, typeof v), dr(null)), v instanceof Error && !(v.message in Kr) && (Kr[v.message] = !0, dr(i), d("Failed %s type: %s", a, v.message), dr(null));
            }
        }
      }
      function Ve(e) {
...
Check the top-level render call using <` + a + ">.");
      ...
      function At(e) {
        if (pr === null)
          try {
            ...
            pr = a.call(J, "timers").setImmediate;
          } catch {
            pr = function(i) {
      ...
      y.Children = Lt, y.Component = _, y.Fragment = re, y.Profiler = Q, y.PureComponent = W, y.StrictMode = te, y.Suspense = V, y.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = U, y.cloneElement = Ft, y.createContext = ir, y.createElement = It, y.createFactory = $t, y.createRef = mr, y.forwardRef = jr, y.isValidElement = _e, y.lazy = kr, y.memo = c, y.startTransition = xt, y.unstable_act = Dt, y.useCallback = K, y.useContext = R, y.useDebugValue = ie, y.useDeferredValue = ht, y.useEffect = Y, y.useId = mt, y.useImperativeHandle = sr, y.useInsertionEffect = A, y.useLayoutEffect = F, y.useMemo = Ee, y.useReducer = b, y.useRef = m, y.useState = S, y.useSyncExternalStore = gt, y.useTransition = yt, y.version = Re, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
...
function Yt() {
  if (dt)
    return Ge;
  dt = 1;
  var J = vt(), y = Symbol.for("react.element"), Re = Symbol.for("react.fragment"), X = Object.prototype.hasOwnProperty, de = J.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, $, Z) {
...
function Bt() {
  return pt || (pt = 1, process.env.NODE_ENV !== "production" && function() {
    var J = vt(), y = Symbol.for("react.element"), Re = Symbol.for("react.portal"), X = Symbol.for("react.fragment"), de = Symbol.for("react.strict_mode"), re = Symbol.for("react.profiler"), te = Symbol.for("react.provider"), Q = Symbol.for("react.context"), $ = Symbol.for("react.forward_ref"), Z = Symbol.for("react.suspense"), L = Symbol.for("react.suspense_list"), V = Symbol.for("react.memo"), ee = Symbol.for("react.lazy"), H = Symbol.for("react.offscreen"), se = Symbol.iterator, Fe = "@@iterator";
    function ne(t) {
    ...
    var oe = !1, N = !1, q = !1, ce = !1, pe = !1, Ce;
    Ce = Symbol.for("react.module.reference");
    function we(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === X || t === re || pe || t === de || t === Z || t === L || ce || t === H || oe || N || q || typeof t == "object" && t !== null && (t.$$typeof === ee || t.$$typeof === V || t.$$typeof === te || t.$$typeof === Q || t.$$typeof === $ || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var G = Object.assign, U = 0, ue, d, fe, Te, n, s, h;
    function C() {
    }
...
`), Y = f.stack.split(`
`), A = m.length - 1, F = Y.length - 1; A >= 1 && F >= 0 && m[A] !== Y[F]; )
            F--;
          for (; A >= 1 && F >= 0; A--, F--)
            if (m[A] !== Y[F]) {
              if (A !== 1 || F !== 1)
...
` + m[A].replace(" at new ", " at ");
                    return t.displayName && K.includes("<anonymous>") && (K = K.replace("<anonymous>", t.displayName)), typeof t == "function" && me.set(t, K), K;
                  }
                while (A >= 1 && F >= 0);
              break;
            }
    ...
    var ge = ae.ReactCurrentOwner, _r = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function wr(t, u, c, f, R) {
      {
        ...
        c !== void 0 && (Be(c), m = "" + c), Er(u) && (Be(u.key), m = "" + u.key), br(u) && (Y = u.ref, Rr(u, R));
        for (S in u)
          Oe.call(u, S) && !_r.hasOwnProperty(S) && (b[S] = u[S]);
        if (t && t.defaultProps) {
        ...
        return Cr(t, m, Y, R, f, ge.current, b);
      }
    }
    ...
    function ur(t, u) {
      {
        ...
        or[c] = !0;
        var f = "";
        t && t._owner && t._owner !== We.current && (f = " It was passed a child from " + z(t._owner.type) + "."), ve(t), I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', c, f), ve(null);
      }
    }
    function ir(t, u) {
      {
    ...
    function ze(t, u, c, f, R, S) {
      {
        ...
        if (!b) {
          ...
          Y ? m += Y : m += De();
          var A;
          t === null ? A = "null" : Ne(t) ? A = "array" : t !== void 0 && t.$$typeof === y ? (A = "<" + (z(t.type) || "Unknown") + " />", m = " Did you accidentally export a JSX literal instead of a component?") : A = typeof t, I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", A, m);
        }
        var F = wr(t, u, c, R, S);
        if (F == null)
          return F;
...
var ye = Mr.exports;
function qt() {
  return /* @__PURE__ */ ye.jsx(ye.Fragment, { children: /* @__PURE__ */ ye.jsx("div", { class: "container ", children: /* @__PURE__ */ ye.jsxs("form", { action: "", children: [
    /* @__PURE__ */ ye.jsx("input", { type: "text", placeholder: "Student Id", name: "id", required: !0 }),
    /* @__PURE__ */ ye.jsx("input", { type: "text", placeholder: "Name", name: "name", required: !0 }),
    /* @__PURE__ */ ye.jsx("input", { type: "email", placeholder: "Email", name: "email", required: !0 }),
    /* @__PURE__ */ ye.jsx(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ ye.jsx("button", { children: "Submit" })
  ] }) }) });
}
export {
  qt as default
